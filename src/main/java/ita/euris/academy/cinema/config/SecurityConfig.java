package ita.euris.academy.cinema.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable().authorizeRequests()
        ...
        .antMatchers("/foods/**").hasRole("manager")
        .antMatchers("/films/**").hasRole("manager")
        .antMatchers("/tickets/**").hasRole("manager")
        .antMatchers("/purchases-cinema/**").hasRole("manager")
        .antMatchers("/food-purchases/**").hasRole("manager")
        .and().httpBasic();
  }
